...
PRINT_START BED=[bed_temperature_initial_layer_single] HOTEND={first_layer_temperature[initial_no_support_extruder]} CHAMBER=[overall_chamber_temperature] EXTRUDER=[initial_no_support_extruder]
